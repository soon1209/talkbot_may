...
def image_introduce():
    ...
    fmt = _("Try now")
    action1 = make_i18n_postback_action("start", "start", "Try now", fmt)
    column1 = make_il8n_image_carousel_column(0, action=action1)

    action2 = make_i18n_postback_action("start", "start", "Try now", fmt)
    column2 = make_il8n_image_carousel_column(1, action=action2)

    action3 = make_i18n_postback_action("start", "start", "Try now", fmt)
